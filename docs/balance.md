...
| --- | --- | ---: | --- |
| `Store` | Патроны | `1` золото | `+1` патрон |
| `Store` | Здоровье | `20` золота | `+20` HP |
| `HAMMER` | Патроны | `1` золото | `+1` патрон |
| `HAMMER` | Damage upgrade | `1000` золота | `x2` урон игрока, один раз |
