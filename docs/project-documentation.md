...
- `TopDownInputAdapter` — чтение ввода `Horizontal/Vertical`, `WASD`, sprint, прыжка, dash и manual respawn
...
- `TopDownFacingController` — разворот персонажа по направлению движения
...
- боевые и анимационные системы с новым мотором пока не интегрированы
